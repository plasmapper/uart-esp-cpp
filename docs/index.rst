...
Examples
--------
| `UART <https://components.espressif.com/components/plasmapper/pl_uart/versions/2.0.0/examples/uart>`_
| `UART echo server <https://components.espressif.com/components/plasmapper/pl_uart/versions/2.0.0/examples/uart_echo_server>`_
